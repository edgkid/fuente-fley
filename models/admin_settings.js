...
module.exports = mongoose.model('Settings', new Schema({
    ...
    backend_google_key: {type: String, default: ""},
    ...
    app_name: {type: String, default: "FLETY"},
    ...
    email_list_trip_notifiy: {type: Array, default:[]},
    base_url: {type: String, default: ""},
    webpush_public_key: {type: String, default: ""},
    webpush_private_key: {type: String, default: ""},
    server_type: {type: Number, default: 2}, // 1 - Live,   2 - Dev
    ...
    connectium_dlr_level: {type: Number, default: ""},
    connectium_dlr_webhook_url: {type: String, default: ""},
    stop_threshold: {type: Number, default: 50},
    emails_notify_registration_data: {type: Array, default:[]}, // Emails for sending daily user registration data
    tracking_link_sms: {type: Boolean, default: false},
    landing_page_url: {type: String, default: ""},
    user_app_insta_ad_url: {type: String, default: ""},
    driver_app_insta_ad_url: {type: String, default: ""},
    advertise_urls: {type: Array, default:[]},
