...
module.exports = function (app) {
    ...
    app.route('/admin_connectium_settings_update').post(admin.connectium_settings_update);
    ...
    app.route('/trip_settings_update').post(admin.trip_settings_update);
    ...
    app.route('/update_firebase_remote_config').post(admin.update_firebase_remote_config);
    app.route('/remove_remote_config_advertise').post(admin.remove_remote_config_advertise);
    app.route('/update_app_redict_url').post(admin.update_app_redict_url);
    app.route('/get_advertisement_urls').post(admin.get_advertisement_urls);
