...
module.exports = function (app) {
    ...
    app.route('/zonevalueajax').post(checkAdminSession, admin.zonevalueajax);
    app.route('/deletezonevalueajax').post(checkAdminSession, admin.deletezonevalueajax);
    app.route('/updatezonevalueajax').post(checkAdminSession, admin.updatezonevalueajax);
