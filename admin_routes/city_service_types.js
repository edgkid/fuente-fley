...
module.exports = function (app) {
    ...
    app.route('/add_modelpricing_data').post(admin.add_modelpricing_data);
    app.route('/update_modelpricing_data').post(admin.update_modelpricing_data);
    app.route('/delete_modelpricing_data').post(admin.delete_modelpricing_data);
