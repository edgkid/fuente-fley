...
module.exports = function (app) {
    ...
    app.route('/aproxdistance').post(users.aproxdistance);
    ...
    app.route('/optimizedorder').post(users.newOptimizedOrder);
    app.route('/new-optimizedorder').post(users.newOptimizedOrder);
    ...
    app.route('/get_user_trip_details').post(users.get_user_trip_details);
    app.route('/chat_push_notification').post(users.chat_push_notification);
    app.route('/get_user_running_trips').post(users.running_trips);
    app.route('/need-ferry').post(users.need_ferry);
    app.route('/get_user_account_deletion_info').get(users.user_account_deletion_info);
