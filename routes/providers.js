...
module.exports = function (app) {
    ...
    app.route('/get_provider_rating').post(providers.get_provider_rating);
    app.route('/provider_accept_reject_partner_request').post(providers.provider_accept_reject_partner_request);
    app.route('/get_provider_trip_details').post(providers.get_provider_trip_details);
    app.route('/provider_start_scheduled_trip').post(providers.provider_start_scheduled_trip);
    app.route('/get_provider_account_deletion_info').get(providers.provider_account_deletion_info);
