...
exports.cities = async function (req, res, next){
	const city_lookup = {
        $lookup:
        {
            from: "cities",
    ...
    const countryname = setting_detail.countryname;
    const country_condition = {$match:{"countryname" : countryname}}
	const country_list = await Country.aggregate([country_condition,city_lookup])
...
exports.user_sign_in = function (req, res, next) {
    req.session.type = 'user';
    res.render('user-login-form', { setting_data: setting_detail });
    delete message;
}

exports.driver_sign_in = function (req, res, next) {
    req.session.type = 'driver';
    res.render('driver-login-form', { setting_data: setting_detail });
    delete message;
}
